# AppManager Process Execution Detailed Design
...
>
> **Related Detailed Design authorities:** `docs/detailed_design/application-invocation-detailed-design-v01.md`, `docs/detailed_design/execution-outcomes-detailed-design-v01.md`, `docs/detailed_design/managed-project-detailed-design-v01.md`, `docs/detailed_design/configuration-resolution-detailed-design-v01.md`, `docs/detailed_design/application-core-bootstrap-resolution-clarification-v01.md`, `docs/detailed_design/application-engine-detailed-design-v01.md`, `docs/detailed_design/resource-access-detailed-design-v01.md`
>
> **Primary Functional authorities:** `docs/functional/application-invocation-functional-specification-v01.md`, `docs/functional/managed-project-functional-specification-v01.md`, `docs/functional/configuration-functional-specification-v01.md`
>
> **Related domain Functional authorities:** App, Docs, Git, Nuxt, Quality, AI, Settings and Utils Functional Specifications where those domains delegate bounded external-tool execution.
...
## 34. Downstream Detailed Design Requirements

Later Detailed Designs shall consume this contract rather than recreate process wrappers independently.
