 ...
 *
 * @project:    app-manager
 * @file:       ~/app/templates/readmeTemplate.ts
 * @version:    1.0.0
 ...
 *
 * This template produces the primary documentation file for projects. It intelligently
 * adapts the content based on the project type:
 *
 * 1. Root Mode ('root'):
 * - Generates a "Getting Started" guide.
 * - Includes standard commands for Setup (install), Development (dev), and Production (build).
 * - Lists environment requirements (Node.js, pnpm).
 *
 * 2. Layer Mode ('layer'):
 * - Generates an "Installation & Usage" guide.
 * - Specifically explains how to register the layer in a host application's
 * nuxt.config.ts 'extends' array.
 * - Highlights specific features provided by the layer.
 *
 * ================================================================================
 *
...
export const readmeTemplate: TemplateFunction<ReadmeContext, string> = (ctx) => {
	...
	if (isRoot) {
		...
		// Layer Integration Instructions
