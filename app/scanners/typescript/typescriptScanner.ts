 ...
 *
 * @project:    app-manager
 * @file:       ~/app/scanners/typescript/typescriptScanner.ts
 * @version:    1.2.0
 ...
 * - Removed the private 'isWhitespace()', 'isDigit()', 'isAlpha()', and
 *   'isAlphaNumeric()' overrides; BaseScanner already exposes all four as
 *   'protected', so the private redeclarations were dead code and a
 *   type-checking conflict (TS2415).
 *
 * V1.1.0, 20260113
