 ...
 *
 * V1.1.1, 20260820
 * Added the required 'type: json' import attribute for NodeNext module
 * resolution when importing llmRegistry.json.
 *
...
import registryData from '../../config/llmRegistry.json' with { type: 'json' };
